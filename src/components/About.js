		...
		<Section className="about">
			<Container className="about__copy">
				...
				<Text tag="p">
					...
					teams with product owners, developers and other designers. In addition
					to my UI/UX toolkit, I've picked up a little bit of HTML/CSS and
					advanced project management skills. Details and organization are my
